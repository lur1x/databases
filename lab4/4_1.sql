...
/* 3.1.a Вставка без указания списка полей (в таблицу genre) */
...
VALUES 
('Крепкий орешек', 132, '1988-07-15', 'R', 'Классический боевик с Брюсом Уиллисом', 1),
('Маска', 101, '1994-07-29', 'PG-13', 'Комедия с Джимом Керри', 2),
('Форрест Гамп', 142, '1994-07-06', 'PG-13', 'Драматическая история простого человека', 3);
...
VALUES ('Тестовый фильм', 90, '2023-01-01', 'PG');
...
/* 3.5.a Сортировка по возрастанию с ограничением (5 самых коротких фильмов) */
